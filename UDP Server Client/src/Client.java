	...
	public static void main(String[] args) {
		...
		try {
			...
			if (message.equals("DISCOVER_FUIFSERVER_RESPONSE")) {
				...
				// your controller)
				SimpleExchangeComm.simpleExchange.Builder builder = SimpleExchangeComm.simpleExchange
						.newBuilder();

				builder.setRequest(simpleExchangeRequest.newBuilder()
						.setRequestType(RequestType.SERVER_INFO));
